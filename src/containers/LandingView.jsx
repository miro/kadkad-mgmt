    ...
    return <div className="landing-view__wrapper">
      ...
      <div className="card__wrapper">
        ...
        <div className="card__content">
          ...
          <p>Sivusto on tehty lähinnä koodaustaitojen kehittämisen vuoksi, sillä toiveella että tälle lopputuotteelle saattaisi löytyä yleisöä edes jonkin verran. (Tästä johtuu myös se, että sivusto on kasattu sellaisilla teknologioilla, mitkä eivät ole ihan 100% vielä lavassa, joten kaikennäköisiä pikkuvikoja ilmenee käytettäesä varmasti.)</p>
